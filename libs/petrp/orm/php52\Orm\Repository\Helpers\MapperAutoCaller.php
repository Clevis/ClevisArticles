 ...
 */
class MapperAutoCaller extends OrmObject
{
	 ...
	 */
	public function __construct(IRepository $repository, OrmAnnotationsParser $parser)
	{
		$reflections = array($reflection = new ReflectionClass($repository));
		while ($reflection = $reflection->getParentClass() AND $reflection->implementsInterface('IRepository'))
		{
