 ...
 */
class NoConventional extends OrmObject implements IDatabaseConventional
{
	...
	{
		$helper = $repository->getModel()->getContext()->getService('repositoryHelper', 'RepositoryHelper');
