 ...
 * @subpackage Common
 */
class OrmAnnotationsParser extends OrmObject
{
	/** @var mixed */
	private $callback;
		...
		if ($callback === NULL)
		{
			...
			if ($detect === NULL)
			{
				...
				{	// @codeCoverageIgnoreStart
					throw new OrmNotSupportedException('Nette\Reflection\AnnotationsParser is not available; You can implement custom parser.');
