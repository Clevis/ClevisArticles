 ...
 */
class DibiManyToManyMapper extends OrmObject implements IManyToManyMapper
{
	/** @var string */
	public $table;
	...
	{
		throw new OrmDeprecatedException(array($this, '$firstParam', $this, '$childParam'));
	}

	/** @deprecated */
	final public function getSecondParam()
	{
		throw new OrmDeprecatedException(array($this, '$secondParam', $this, '$parentParam'));
	}
