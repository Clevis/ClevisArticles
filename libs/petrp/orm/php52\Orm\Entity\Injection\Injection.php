 ...
 */
abstract class Injection extends OrmObject implements IEntityInjection, IEntityInjectionStaticLoader
{
	...
	public static function create($className, IEntity $entity, $value)
	{
		...
		{
			throw new OrmInvalidArgumentException(array('', get_class($entity) . ' injection loaded via ' . __CLASS__ . '::create()', 'subclass of ' . __CLASS__, $className));
		}
