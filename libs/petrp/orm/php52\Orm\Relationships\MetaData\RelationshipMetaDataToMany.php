...
/**
 * MetaData for ManyToMany and OneToMany.
...
abstract class RelationshipMetaDataToMany extends RelationshipMetaData implements IEntityInjectionLoader
{
	...
	{
		if ($type !== MetaData::OneToMany AND $type !== MetaData::ManyToMany) throw new OrmInvalidArgumentException;
	...
	{
		$type = $this->getType();
		$mainClass = $type === MetaData::ManyToMany ? 'ManyToMany' : 'OneToMany';
