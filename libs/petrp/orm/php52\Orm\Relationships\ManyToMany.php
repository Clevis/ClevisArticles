 ...
 *
 * /**
 *  * @property ManyToMany $bars {m:m BarsRepository foos map}
 *  * /
 * class Foo extends Entity {}
 *
 * /**
 *  * @property ManyToMany $foos {m:m FoosRepository bars}
 *  * /
	...
	final protected function getCollection()
	{
		if ($this->get === NULL)
		{
			if ($this->getModel(false))
			{
				...
				{
					throw new BadReturnException(array($this, 'loadCollection', 'IEntityCollection', $all));
				}
			}
			else
			{
