 ...
 */
class EventArguments extends OrmObject
{
	/** @var array */
	public $data;
	...
	public function __construct($type, IRepository $repository, IEntity $entity = NULL, array $arguments = array())
	{
		...
		{
			throw new OrmInvalidArgumentException(array($this, '$type', 'valid event type', $type));
		}
		...
		if (isset($this->keys['entity']))
		{
			...
			if (!$entity)
			{
				throw new OrmInvalidArgumentException(array($this, '$entity', 'instance of IEntity', $entity));
			}
		}
		...
		if (isset($this->keys['operation']))
		{
			...
			{
				throw new OrmInvalidArgumentException(array($this, '$operation', 'update|insert', $this->operation));
			}
		}
	...
	public function getEntity()
	{
		if (!$this->entity)
		{
			throw new OrmMemberAccessException("Cannot read an undeclared property EventArguments::\$entity.");
		}
		return $this->entity;
	}
	...
	public function getOperation()
	{
		if (!$this->operation)
		{
			throw new OrmMemberAccessException("Cannot read an undeclared property EventArguments::\$operation.");
		}
	...
	public function check()
	{
		if (isset($this->keys['id']))
		{
			...
			{
				throw new OrmInvalidArgumentException(array($this, '$id', 'scalar', $this->id));
			}
		}
		if (isset($this->keys['data']))
		{
			...
			{
				throw new OrmInvalidArgumentException(array($this, '$data', 'array', $this->data));
			}
		}
		if (isset($this->keys['params']))
		{
			...
			{
				throw new OrmInvalidArgumentException(array($this, '$params', 'array', $this->params));
			}
		}
		if (isset($this->keys['values']))
		{
			...
			{
				throw new OrmInvalidArgumentException(array($this, '$values', 'array', $this->values));
			}
		}
	}
