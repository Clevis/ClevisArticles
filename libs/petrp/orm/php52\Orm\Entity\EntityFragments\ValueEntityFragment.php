...
abstract class ValueEntityFragment extends AttachableEntityFragment
{
	...
	final public function hasParam($name, $mode = NULL)
	{
		...
		throw new OrmInvalidArgumentException(array('Entity', 'hasParam() $mode', 'MetaData::READWRITE, READ or WRITE', $mode));
	}
	...
	final public function isChanged($name = NULL)
	{
		...
		{
			throw new OrmDeprecatedException(array('Entity', 'isChanged(TRUE)', 'Entity', 'markAsChanged()'));
		}
		if ($name === NULL)
		{
